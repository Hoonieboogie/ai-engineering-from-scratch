...
![घटक मैट्रिक्स के रूप में (2D): R(θ) = [[cos θ, -sin θ], [sin θ, cos θ]] के स्तंभ हैं जहां आधार वेक्टरों को θ द्वारा विपरीत घड़ी के दिशा में घूमने के बाद लैंड किया जाता है। θ = 90° के लिए, [1,0] → [0,1] और [0,1] → [-1,0]; लंबाई और कोण अपरिवर्तित हैं.](matrix_rotation.png)
...
![शेरिंग (2D): एक क्षैतिज स्लाइड Shx = [[1, k], [0, 1]] प्रत्येक बिंदु को उसकी ऊंचाई के अनुपात में पक्ष में स्लाइड करता है (k=1 sends [0,1] → [1,1]), जबकि एक ऊर्ध्वाधर स्लाइड श्या = [[1, 0], [k, 1]] स्लाइड उनके x के अनुपात में ऊपर इंगित करता है। आयताकार समानांतर बन जाते हैं; क्षेत्र समान रहते हैं।
