...
शेष (a - proj_b(a)) b के लिए लंबवत है। यह ऑर्तोगनल विघटन न्यूनतम-वर्ग फिट की नींव है।
...
W_effective = W (मुश्किल) + A@B (प्रशिक्षित)

- A@B = ΔW = एक छोटे से सुधार जोड़ा W → के ऊपर यह आप प्रशिक्षण है।
