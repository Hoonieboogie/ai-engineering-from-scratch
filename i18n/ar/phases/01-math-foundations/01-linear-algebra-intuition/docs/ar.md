...
البقية (a - proj_b(a)) هي عمودية إلى b. هذا التفكك المُستقيم هو أساس أقل مربعات fit.
...
W_effective = W (مجمود) + A@B (مدرّب)

- A@B = ΔW = تصحيح صغير أضاف فوق W → هذا ما تدرب عليه.
