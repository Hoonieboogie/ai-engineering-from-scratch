...
El residual (a - proj_b(a)) es perpendicular a b. Esta descomposición ortogonal es la base de los cuadrados mínimos.
...
W_effective = W (congelado) + A@B (entrenado)

- A@B = ΔW = una pequeña corrección añadida encima de W → esto es lo que entrenas.
