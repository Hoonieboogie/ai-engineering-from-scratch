...
Geri kalan (a - proj_b(a)) b'ye diktirlidir. Bu ortogonal parçalanma en az kare fitin temelini oluşturur.
...
W_effective = W (dondurulmuş) + A@B (eğitimli)

- A@B = ΔW = W'nin üstüne küçük bir düzeltme eklenir → bu eğitiminiz.
