...
3. Ne kadar GPU belleği olduğunuzu kontrol edin ve yerleştirilebilecek en büyük modelin tahmin edilmesini sağlayın (barmak kuralı: fp16 için parametresi başına 2 byte)
   1. Cevap:
      ...
      $$
   2. Gerçeklik: Ağırlıklara ihtiyacın var .**activations**+ **KV cache (for transformers)**. Aktifleştirmeler/bütçe boyutu ve dizi uzunluğu ile birlikte önbelleğe alınan ölçek.
